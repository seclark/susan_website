...
\address{School of Natural Sciences \hfill seclark@ias.edu \\ 1 Einstein Drive \hfill \href{http://www.sns.ias.edu/~seclark}{\tt sns.ias.edu/$\sim$seclark} \\ Princeton, New Jersey 08540 \hfill  github: seclark\\} % Your address
\lhsaddress{stuff}
...
Member, Institute for Advanced Study \hfill{2017 -- present}
\end{rSection}
...
\item {\bf S.E. Clark}. \textit{A new probe of line-of-sight magnetic field tangling}. 2018, {submitted}. 
...
\begin{etaremune}
\item J.E.G. Peek, B.L. Babler, Y. Zheng, {\bf S.E. Clark}, K.A. Douglas, E.J. Korpela, M.E. Putman, S. Stanimirovi\'c, S.J. Gibson, C. Heiles. \textit{The GALFA-HI Survey Data Release 2}. 2018, ApJS 234, 1.
...
\begin{etaremune}
\item {\bf S.E. Clark}. \textit{Galactic neutral hydrogen and the magnetic ISM foreground.} 2017, in Jeli\'c \& van der Hulst (Eds.) {\it Peering towards Cosmic Dawn}, Proceedings of the International Astronomical Union, Symposium No. 333, Dubrovnic, Croatia
...
%Upcoming invited talks: Princeton SFIR seminar; ``Cosmic Rays, Astrophysical Turbulence and Magnetic Reconnection" conference in Natal, Brazil; Prize talk at Fall ASNY Meeting, Siena College, NY; AAS Special Session ``New, Fundamental, Cutting-Edge Science from Arecibo Observatory"
...
% Software dev
%\begin{rSection}{Open Source Development}
%\href{http://seclark.github.io/RHT/}{\tt The Rolling Hough Transform}, a machine vision algorithm for quantifying the linearity of structures in the image plane.\\
%\href{https://bitbucket.org/jsoishi/eigentools/}{\tt eigentools}, python tools for solving eigenvalue problems. Developed for the open-source pseudospectral code \href{http://dedalus-project.org/}{\tt Dedalus}. 
%\end{rSection}
...
Jessica Campbell, University of Toronto, PhD coadviser with Bryan Gaensler \hfill{2017 -- present}\\
Larry Li, Columbia University, undergraduate research \hfill{2016 -- present}\\
Garrison Grogan, Columbia University, undergraduate research \hfill{2016 -- 2017}\\
...
%CMB Probe Galactic Science Working Group \\
%Galactic Arecibo L-Band Feed Array HI Survey (GALFA-HI)\\
%GASKAP
%\end{rSection}
